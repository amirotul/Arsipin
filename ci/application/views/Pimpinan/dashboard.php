...
<html lang="en">
    <head>
        ...
        <title>Arspinin - Dashboard Pimpinan</title>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="jenis-dokumen.html">Jenis Arsip</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xl-3">
                                    <div class="card mini-stat">
                                        ...
                                        <div class="p-4">
                                            <h6 class="text-uppercase mb-3">Disetujui</h6>
                                            <h4 class="mb-0">10<small class="ml-2"></small></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-xl-3">
                                    <div class="card mini-stat">
                                        ...
                                        <div class="p-4">
                                            <h6 class="text-uppercase mb-3">Diabaikan</h6>
                                            <h4 class="mb-0">5<small class="ml-2"></small></h4>
                                        </div>
                                    </div>
                                </div>
