...
<div class="content-page">
    ...
    <div class="content">
                ...
                <ul class="list-inline float-right mb-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a class="dropdown-item" href="profile.html"><i class="mdi mdi-account-circle "></i>
                            Profile</a>
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="float-left">
                                            <p>
                                                <a href=form-add-surat-masuk.html>
                                                    <button type="button" class="btn btn-info btn-lg">Tambah Data</button></p>
                                                </a>
                                                <p><a class="waves-effect waves-light" href="#"><i
                                                    class="mdi mdi-numeric-9-plus-box-multiple-outline"></i> Kirim ke Pimpinan</a>
                                                    <a class="waves-effect waves-light" href="#"><i
                                                        class="mdi mdi-numeric-9-plus-box-multiple-outline"></i> Tambah Disposisi</a></p>
                                                        ...
                                                        <table class="table" id="my-table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>SR-124</td>
                                                                    <td>4 Oktober 2021</td>
                                                                    <td>8 Oktober 2021</td>
                                                                    <td>Shopee</td>
                                                                    <td>Meeting</td>
                                                                    <td>meet-shopee.pdf</td>
        ...
        <script src="<?php echo base_url();?>assets/pages/edit-table.js"></script>
