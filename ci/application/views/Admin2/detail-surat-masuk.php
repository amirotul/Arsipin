                                ...
                                <div class="card-body">
                                    <div class="list-group mail-list">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="SR-121" id="example-text-input" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="1 Oktober 2021" id="example-text-input" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="4 Oktober 2021" id="example-text-input" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="Perizinan lokasi PKL" id="example-text-input" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="6 Oktober 2021" id="example-text-input" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="10 Oktober 2021" id="example-text-input" disabled>
                                            </div>
                                        </div>
