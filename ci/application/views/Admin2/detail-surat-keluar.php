<form class="user" action="<?php echo base_url('Surat_Keluar/detail-surat-keluar');?>" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="btn-toolbar mb-3" role="toolbar">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                            ...
                                            <iframe type="application/pdf" src="<?php echo base_url();?>assets/upload/file_sk/<?php echo $baris->file_sk; ?>" id="file_sk" name="file_sk" width="500" height="370"></iframe>
                                        </div>
                                    </div>
                                    <div class="form-group row">
