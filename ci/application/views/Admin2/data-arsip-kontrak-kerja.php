...
<html lang="en">
    ...
    <head>
        ...
        <title>Arsipin - Data Kontrak Kerja</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Data Kontrak Kerja</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                    ...
                                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>1</td>
                                                                    <td>Kontrak Kerja CV Hummasoft</td>
                                                                    <td>Kontrak Kerja</td>
                                                                    <td>14/10/2021</td>
                                                                    <td><a href=form-edit-data-kontrak-kerja.html>
                                                                        ...
                                                                        &nbsp
                                                                        <a href=lihat-kontrak-kerja.html>
