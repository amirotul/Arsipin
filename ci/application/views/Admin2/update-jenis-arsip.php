                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Nama/Jenis Arsip</label>
                            <div class="col-sm-5">
                                <input class="form-control" type="text" value="Akte Perusahaan" id="example-text-input">
                            </div>
                        </div>
