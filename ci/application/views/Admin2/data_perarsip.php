                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                echo '<a href="' . base_url('Data_Arsip/edit_data_arsip/' . $baris->id_arsip . '?id_jenis=' . $id_jenis) . '"><button type="button" class="btn-primary">Edit</button></a>';
                                                echo " ";
                                                echo '<button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteModal" data-id-dataarsip="' . $baris->id_arsip .  '?id_jenis=' . $id_jenis . '">Hapus</button>';
                                                echo " ";
                                                echo '<a href="' . base_url('Data_Arsip/detail_data/' . $baris->id_arsip . '?id_jenis=' . $id_jenis) . '"><button type="button" class="btn-warning">Detail</button></a>';
                                                ?></td>
                                        </tr>
                                    <?php
                                    } ?>
