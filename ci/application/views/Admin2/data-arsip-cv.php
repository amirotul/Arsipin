            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <a href="#" class="logo"><img src="assets/images/logo.png" height="14" alt="logo"></a>
                    </div>
                </div>
                    ...
                    <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect waves-light"><i
                            ...
                            <ul class="list-unstyled">
                                <li><a href="jenis-arsip.html">Jenis Arsip</a></li>
                                <li><a href="data-arsip.html">Data Arsip</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Data CV</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                                    ...
                                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>1</td>
                                                                    <td>CV CV Hummasoft</td>
                                                                    <td>CV</td>
                                                                    <td>14/10/2021</td>
                                                                    <td><a href=form-edit-data-cv.html>
