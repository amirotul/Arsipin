<form class="user" action="<?php echo base_url('Jenis_Divisi/input_jenis_divisi');?>" method="post">
                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input class="form-control" type="text" value="" id="jenis_divisi" name="jenis_divisi">
                                                </div>
                                            </div>
