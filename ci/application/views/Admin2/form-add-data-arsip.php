        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Data Arsip</h4>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="jenis_arsip">
                                    ...
                                    <option value="akte perusahaan">Akte Perusahaan</option>
                                    <option value="akte perusahaan">MOU</option>
                                    <option value="akte perusahaan">Kontrak Kerja</option>
                                    <option value="akte perusahaan">NPWP</option>
                                    <option value="akte perusahaan">TDP</option>
                                    <option value="akte perusahaan">CV</option>
                                </select>
