                            ...
                            <?php foreach ($user as $baris) { ?>
                                <form class="user" action="<?php echo base_url('Disposisi/update'); ?>" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control-file" type="file" accept="application/pdf" value="<?php echo $baris->catatan_dis; ?>" id="file_dis" name="file_dis" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">File</label>
                                        <div class="col-sm-5">
                                        <iframe type="application/pdf" class="w-100" src="<?php echo base_url();?>assets/upload/file_sm/<?= $user['file_dis'] ?>" id="file_dis" name="file_dis" width="520" height="370"></iframe>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-3">
