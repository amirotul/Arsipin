                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input class="form-control" type="varchar" value="SR-121" id="example-number-input">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input class="form-control" type="text" value="Politeknik Negeri Jember" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Perihal</label>
                            <div class="col-sm-5">
                                <input class="form-control" type="text" value="PKL" id="example-text-input">
                            </div>
                        </div>
                        <div class="form-group row">
